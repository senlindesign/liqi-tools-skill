...
![IMG_2506](https://liqi.io/images/10210-908x1024.jpg)
...
![akid‘s iphone](https://liqi.io/images/59726-577x1024.png)
...
[https://nuzzel.com/](https://nuzzel.com/) 在这个网站上使用你的 Twitter 帐号登录，根据它的算法就可以把你 Follow 的帐号中分享最多以及被整个 Twiiter 使用者热议的文章集合成一封 Newsletter，你可以在每条新闻的下发看到哪些帐号分享了这篇文章，让人想起以前使用 Google Reader 时，看到哪些友邻分享了同一篇文章的画面。
